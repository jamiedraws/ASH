...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <section class="u-pad @mv-u-pad--vert">
        <!--Contact Info-->
        <%
        ...
        <label for="TermsAndPolicy" class="checkbox">
            ...
            <span class="checkbox__item">By submitting my order, I agree to the <a target="_blank" rel="noreferrer noopener" id="digital-river-terms-of-sale-verify" href="<%= digitalRiverTermsOfSale %>">Terms of Sale</a> and the <a target="_blank" rel="noreferrer noopener" id="digital-river-privacy-policy-verify" href="<%= digitalRiverPrivacyPolicy %>">Privacy Policy</a> of <%= digitalRiverCompanyName %></span>
        </label>

        <div class="view__actions">
            <button name="acceptOffer" id="AcceptOffer" type="submit" class="button">
        ...
        <p class="u-mar--top fn--center"><%= LabelsManager.Labels["OSWEConfirmOrderButtonDisclaimer"] %></p>
