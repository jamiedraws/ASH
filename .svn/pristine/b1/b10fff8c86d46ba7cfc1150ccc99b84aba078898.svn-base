...
<footer data-eflex-footer-custom aria-label="Copyrights and policies" class="view view--footer footer">
    <div class="view__in">
        ...
        <p>Looking for individual items from this kit? <a href="https://www.getalexastarterkit.com?mid=11825720" id="kit-to-parts-link" target="_blank">Click here to visit the Alexa Smart Home Store.</a></p>
        <%
