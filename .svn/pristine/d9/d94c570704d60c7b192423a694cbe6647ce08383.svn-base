<%@ Page Language="C#" MasterPageFile="~/ASHPARTS/Views/Layouts/ConfirmationLayout.master" Inherits="System.Web.Mvc.ViewPage<Dtm.Framework.ClientSites.Web.ClientSiteViewData>" %>
